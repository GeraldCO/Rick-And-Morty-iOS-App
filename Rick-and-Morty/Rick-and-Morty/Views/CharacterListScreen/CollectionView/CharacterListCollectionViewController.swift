...
final class CharacterListCollectionViewController: UICollectionViewController, UICollectionViewDataSourcePrefetching {
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(UINib(nibName: String(describing: CharacterItemCell.self), bundle: nil), forCellWithReuseIdentifier: "CharacterItemCell")
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        viewModel.didTapElement(elementId: characterId)
    }
    ...
    private func createDatasource() -> DataSource {
        ...
        UICollectionViewDiffableDataSource(collectionView: collectionView, cellProvider: { [unowned self] collectionView, indexPath, _ in
            ...
            let cell: CharacterItemCell = collectionView.dequeueReusableCell(withReuseIdentifier: "CharacterItemCell", for: indexPath) as! CharacterItemCell
            cell.configure(with: character)
            cell.cornerRadius = 25
            cell.dropShadow()
